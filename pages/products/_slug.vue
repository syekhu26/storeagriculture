        ...
        <div class="col-md-8">
          <div class="card border-0 rounded shadow-sm">
            <div class="card-body">
              ...
              <hr>
              <button @click="addToCart(product.id, calculateDiscount(product), product.weight)" class="btn btn-lg btn-success border-0 shadow-sm"><i class="fa fa-shopping-cart"></i> TAMBAH KE
                KERANJANG</button>
            </div>
          </div>
        </div>
...
<script>
  export default {
    head() {
      return {
        title: `${this.product.title} - Store Agriculture`,
        meta: [{
            hid: 'og:title',
            name: 'og:title',
            content: `${this.product.title} - Store Agriculture`,
          },
          {
            hid: 'og:site_name',
            name: 'og:site_name',
